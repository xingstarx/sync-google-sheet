...
| android,iOS | consolidation_utxo_description | Your number of UTXOs exceeds 256. For sending experience, please enter the PIN to consolidating UTXOs before operating. | 您资产的 UTXO 太零碎了，请输入 PIN 合并后再进行转账或提现操作 |     |     |     |

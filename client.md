...
| android, iOS | not_supported_deposit | Mixin Wallet now does not support %1$s deposit, please note that the transferred %2$s assets can continue to transfer or withdraw, read the document to learn more. |     |     |     |     |

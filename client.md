...
| android, iOS | not_supported_deposit | Mixin Wallet does not support the deposit for %1$s. Please note that you can continue to transfer or withdraw the deposited assets. Read the document to learn more. | Mixin 钱包现已不支持 %1$s 充值，注意已转入的 %1$s 资产可以继续转账或提现，阅读文档了解更多。 |     |     |     |

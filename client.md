...
| android, iOS | not_supported_deposit | Mixin Wallet now does not support %1$s deposit, please note that the transferred %2$s assets can continue to transfer or withdraw, read the document to learn more. | Mixin 钱包现已不支持 %1$s 充值，注意已转入的 %1$s 资产可以继续转账或提现，阅读文档了解更多。 |     |     |     |
